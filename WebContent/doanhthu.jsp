						...
						<div class="panel panel-default">
							...
							<div class="container">
								<form action="doanhthutheotg" method="post">
									...
									<input type="date" id="date1" name="ngay1" value="${ngaymot}">
									<label for="date2">To:</label>
									<input type="date" id="date2" name="ngay2" value="${ngayhai}">
											...
											<div class="timeline-panel">
												...
												<div class="timeline-body">
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing
														...
														beatae consequuntur impedit nulla qui! Laborum, atque.</p>
													<hr>
													<div class="btn-group">
														<button type="button"
